...
// =============================================================================
if (process.env.NODE_ENV === 'test') {
  // dispatchHistoryCollection/proxyEventsCollection/resetKpiCache (LIN-3002):
