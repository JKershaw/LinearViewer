...
export const testMockData = {
  ...
  issues: [
    ...
    { id: 'issue-2', identifier: 'TEST-2', title: 'Child task todo', description: 'A child task', estimate: 2, priority: 3, sortOrder: 2, createdAt: '2024-01-02T00:00:00Z', dueDate: null, completedAt: null, url: 'https://linear.app/test/issue/TEST-2', parent: { id: 'issue-1' }, project: { id: 'proj-alpha' }, state: { name: 'Todo', type: 'unstarted' }, assignee: null, labels: { nodes: [] }, team: { id: 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee' } },
    ...
    { id: 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeef', identifier: 'TEST-14', title: 'Add pagination to user list', description: 'Implement cursor-based pagination for the user list API endpoint to handle large datasets efficiently', estimate: 3, priority: 2, sortOrder: 11, createdAt: '2024-01-14T00:00:00Z', dueDate: '2024-02-15', completedAt: null, url: 'https://linear.app/test/issue/TEST-14', parent: null, project: { id: 'proj-alpha' }, state: { name: 'In Progress', type: 'started' }, assignee: { name: 'Alice' }, labels: { nodes: [] }, team: { id: 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee' } },
    { id: 'ffffffff-ffff-ffff-ffff-ffffffffffff', identifier: 'TEST-15', title: 'Refactor authentication module', description: 'Extract auth logic into separate service for better testability and reuse across API endpoints', estimate: 5, priority: 2, sortOrder: 12, createdAt: '2024-01-15T00:00:00Z', dueDate: null, completedAt: null, url: 'https://linear.app/test/issue/TEST-15', parent: null, project: { id: 'proj-alpha' }, state: { name: 'In Review', type: 'started' }, assignee: { name: 'Bob' }, labels: { nodes: [] }, team: { id: 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee' }, relations: { nodes: [{ type: 'blocks', relatedIssue: { id: 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeef' } }] } }
  ]
}
