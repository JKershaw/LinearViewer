...
export const testMockData = {
  ...
  issues: [
    ...
    { id: '66666666-6666-6666-6666-666666666666', title: 'Task needing breakdown', description: 'This task needs to be broken down into smaller pieces', estimate: 8, priority: 2, sortOrder: 3, createdAt: '2024-01-06T00:00:00Z', dueDate: '2024-04-01', completedAt: null, url: 'https://linear.app/test/issue/TEST-6', parent: null, project: { id: 'proj-alpha' }, state: { name: 'Backlog', type: 'backlog' }, assignee: { name: 'Alice' }, labels: { nodes: [{ name: 'needs-breakdown' }] }, team: { id: 'eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee' } }
  ]
}
