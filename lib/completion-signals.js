...
export const COMPLETION_SIGNALS = {
  ...
  'review': {
    coreOutcome: 'Implementation verified ready for production and closed out (or a closure blocker filed and routed to)',
    signals: [
      ...
      'Merged state verified (deploy verified when observable)',
      'Related Linear tasks reconciled (parent/siblings/follow-ups current)',
      'If CI red or a blocker surfaced: closure blocker filed/linked as `blocks` and named as the next action'
    ],
    readinessCheck: 'Is the code merged with CI green and closed out — or, if not, is a closure blocker filed and routed to?'
  },
  'retro': {
