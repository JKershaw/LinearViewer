...
export const COMPLETION_SIGNALS = {
  ...
  'close-out': {
    ...
    signals: [
      'Latest review comment\'s `### What CI Did Not Prove` ledger read and parsed (a missing/unparseable ledger blocks — it is never treated as empty)',
    ...
    readinessCheck: 'Is every ledger item discharged or explicitly accepted (a missing/unparseable ledger blocks; an explicitly empty ledger is a cheap no-op) and the work then merged, set Done, summarized, and followed-up?'
  },
  'retro': {
