...
import { PHASE_LABELS, WORK_ISSUE_LABELS } from './workflow-config.js';
...
export const COMPLETION_SIGNALS = {
  [PHASE_LABELS.RESEARCH]: {
    ...
    signals: [
      'Codebase examined with specific files/locations referenced',
    ...
    readinessCheck: 'Could an implementor start work based on verified findings?'
  },
