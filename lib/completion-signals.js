...
export const COMPLETION_SIGNALS = {
  ...
  'retro': {
    coreOutcome: 'Honest retrospective recorded with downstream effects assessed and actionable lessons captured',
    signals: [
      'What actually happened reconstructed from Linear and git history',
      'Downstream effects assessed (follow-up fixes, reverts, regressions, reopened work) — or confirmed none',
