...
export const COMPLETION_SIGNALS = {
  ...
  'plan': {
    coreOutcome: 'Implementation complete with tests passing',
    signals: [
      'Implementation plan documented in description',
      'Code changes implemented following the plan',
      'Tests written for new/changed behavior',
      'All tests passing',
      'Commit pushed with descriptive message'
    ],
    readinessCheck: 'Is there a clear implementation plan ready to execute?'
  },
  'code-review': {
