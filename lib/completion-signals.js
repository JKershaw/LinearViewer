...
export const COMPLETION_SIGNALS = {
  ...
  'plan-review': {
    ...
    readinessCheck: 'Plan-review verifies, it does not redesign — were all six of the plan\'s grounding claims re-run independently, and is an explicit verdict recorded that either hands off to implementation or names what the plan must fix?'
  },
  'implementation': {
  ...
  'close-out': {
    coreOutcome: 'Approved work landed: the Not-Proven-by-CI ledger is discharged, the PR merged, the task Done, the summary posted, the description archived and pruned of superseded stage artifacts, and remaining follow-ups filed',
    signals: [
