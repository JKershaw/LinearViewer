...
export const COMPLETION_SIGNALS = {
  ...
  'plan': {
    coreOutcome: 'Implementation plan documented with execution structure named',
    signals: [
      ...
      'Surfaces enumerated with their dependency arrows',
      'Execution structure named in the description (single pass, sequential chain, foundation + parallel, or hybrid)'
    ],
    readinessCheck: 'Does the plan document files, approach, and testing, and does it name an execution structure?'
  },
  'code-review': {
