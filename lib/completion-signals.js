...
export const COMPLETION_SIGNALS = {
  ...
  'review': {
    ...
    readinessCheck: 'Review does not merge or mark Done (the merger does that post-merge) — is an explicit verdict issued with CI green on the PR (Approve authorizes the merge), or, if not, is a closure blocker filed and routed to?'
  },
  'retro': {
