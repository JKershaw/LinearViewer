...
export function renderMergeConfirmPage({ identityLabel }) {
  ...
  <div class="login-container" data-testid="merge-confirm-page">
    ...
    <p class="error-message">This ${escapeHtml(identityLabel)} account is already connected to a different Harbour account. Since you're signed in as your other account right now, this looks like the same person — merge them?</p>
    ${body}
  </div>`
  })
}
