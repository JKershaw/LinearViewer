...
export function renderNextRunPage(data = {}, options = {}) {
  ...
  const nextRunData = { urlKey: urlKey || '' };
  ...
  // Deterministic intro paragraph above the options (LIN-638). Hidden until a
  // generation returns; filled by next-run.js from the suggest response `summary`.
