...
export const AVAILABLE_MODELS = [
  ...
  { id: 'anthropic/claude-opus-4.8', name: 'Claude Opus 4.8', description: 'Frontier reasoning' },
  { id: 'openai/gpt-5.4-mini', name: 'GPT-5.4 Mini', description: 'Fast OpenAI workhorse' },
  { id: 'openai/gpt-5.5', name: 'GPT-5.5', description: 'OpenAI frontier' },
  { id: 'google/gemini-3.5-flash', name: 'Gemini 3.5 Flash', description: 'Near-Pro reasoning, low latency' },
  { id: 'google/gemini-3.1-flash-lite', name: 'Gemini 3.1 Flash Lite', description: 'Cheapest Gemini, fast' },
  { id: 'google/gemini-3.1-pro-preview', name: 'Gemini 3.1 Pro', description: 'Google frontier' },
  { id: 'deepseek/deepseek-v4-flash', name: 'DeepSeek V4 Flash', description: 'Best value, ultra-cheap' },
  { id: 'deepseek/deepseek-v4-pro', name: 'DeepSeek V4 Pro', description: 'Cheap frontier' },
  { id: 'moonshotai/kimi-k2.6:free', name: 'Kimi K2.6 (free)', description: 'Free, strong general model' },
];
