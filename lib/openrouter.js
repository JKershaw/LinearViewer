...
export const AVAILABLE_MODELS = [
  { id: 'anthropic/claude-sonnet-4', name: 'Claude Sonnet 4', description: 'Default - balanced quality/cost' },
  { id: 'anthropic/claude-opus-4', name: 'Claude Opus 4', description: 'Highest quality' },
...
function buildMetaPrompt(issue, context) {
  ...
  return buildMetaPromptTemplate({
    ...
    hasSubtasks,
    subtaskCount: context.children?.length || 0,
    hasComments,
