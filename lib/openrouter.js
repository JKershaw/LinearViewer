...
Goal: "Research the codebase, identify files to modify, and implement with test coverage."
Workflow: Set status to "In Progress" → Implement → Set status to "Done" and add summary comment
