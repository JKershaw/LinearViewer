...
export class LocalProvider extends ProviderInterface {
  ...
  get landingCatalogue() {
    return { blurb: 'writable, no tracker', order: 4 }
  }

  // No addProvider: Local's onboarding door is POST /workspace/new, not
  // /providers/add — a Settings "+ Local" row would fall through to
  // server.js's unsupported-add branch.
  // No entryCta: Local has no new-login entry point.
