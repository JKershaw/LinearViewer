...
export const PROVIDER_SURFACE = {
  ...
  // `/api/proxy/issues/:id` (`issueDetail`) — `/api/proxy/projects`'s gate is
  // LIN-2355's, and `/api/proxy/issues` (list)'s is LIN-1573's (which owns the
  // route gating for both of the two left ungated here). This is the
  // deliberate CONTRAST with the route-internal reads just below
