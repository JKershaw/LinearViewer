...
// `fields._transitions: [{ id, name, to: { statusCategory: { key } }, fields? }]`
// (also stripped before the issue is returned) — an entry with a non-empty
// `fields` simulates a screen-required transition (`updateIssue`'s D2 refusal).
