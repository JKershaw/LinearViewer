...
// off) and story-point mapping (LIN-1888). OAuth 3LO is NO LONGER out of scope
// — it landed as LIN-1887/LIN-1890 (routes/jira-auth.js; `JIRA_OAUTH_SCOPES`
// includes `write:jira-work`) and sits alongside the API-token Basic shape.
// See LIN-275's
