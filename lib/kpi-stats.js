...
// Weekly buckets for the dispatch-outcome trend. Deliberately NOT
// WEEKLY_WINDOW_WEEKS: that span is 5 weeks = 35 days, but `historyTtl`
// defaults to 30 days (lib/dispatch-store.js), so its oldest bucket is
// systematically under-filled by rows that have already aged out. Four whole
// weeks (28 days) is the largest span that fits inside the retention window.
