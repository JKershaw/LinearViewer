...
export function renderSwimPage(data, options = {}) {
  ...
  const { deployInfo = {}, urlKey = null, openRouterSource = null, workspaces = [], featureFlags = {}, isLanding = false } = options;
  ...
  const navBarHtml = renderNavBar({ workspaces, urlKey, currentPage: 'swim', featureFlags, isLanding });
  ...
  return renderPage({
    ...
    content: `<main class="swim-page" data-url-key="${encodedUrlKey}">
