 ...
 *   - The archive section — a link to the standalone Harbour Archive museum
 *     page at /archive/1 (served verbatim from docs/archive/).
...
<span class="lx-c-key">$</span> _</pre>
    ...
    <section class="lx-section lx-archive" data-testid="landing-archive" aria-labelledby="lx-archive-h">
      ...
      <a href="/archive/1" class="lx-archive__link" data-testid="landing-archive-link">Visit the Harbour Archive →</a>
    </section>
  </main>
  ${footerHtml}`;
