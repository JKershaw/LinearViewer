...
export function renderProxyPage(workspaceName = 'Workspace', options = {}) {
  ...
  <main>
    ...
    ${renderSection({ boxed: true, className: 'proxy-section', titleClass: 'section-header proxy-section-header', title: `<a href="/workspace/${encodedUrlKey}/foreman" style="text-decoration: none; color: inherit;">Foreman <span class="foreman-experimental">experimental</span></a>`, body: `<p class="proxy-hint">Autonomous task runner — copy a playbook prompt and let an AI agent work through your task stack.</p>` })}
