...
<body>
  ...
  <main>
    <section class="proxy-section">
      ...
      <div class="proxy-prompt-box" data-url-key="${encodedUrlKey}">
        <div class="proxy-prompt-controls">
          ...
          <button class="dispatch-action save" id="proxy-generate-btn">generate &amp; copy</button>
    ...
    <section class="proxy-section">
      <h2 class="proxy-section-header">Event Log <button class="dispatch-action proxy-events-refresh">refresh</button></h2>
