 ...
 *
 * @param {string} message
 * @returns {{harness?: string, model?: string, inputTokens?: number, outputTokens?: number, cacheCreationInputTokens?: number, cacheCreation1hInputTokens?: number, cacheReadInputTokens?: number, lane: string|null, costUsd: number|null}|null}
 */
...
// the same mechanism `parseUsagePayload` uses for its four token-count fields.
