...
export class DismissalSuggestionsStore {
   ...
   * @param {string} entry.urlKey
   * @param {string} entry.decisionId
   * @param {string} [entry.decisionLoopId] - LIN-2756: must match whatever
   *   the standing suggestion was proposed with (present or omitted) — a Keep
   *   targets the SAME `_id` a `suggest()` call would have addressed.
