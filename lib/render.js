  ...
  if (!isLanding && featureFlags.promptButtons !== false) {
    ...
    if (featureFlags.proxy === true) {
      ...
      const foremanActions = featureFlags.dispatch === true
        ? renderDispatchDisclosure(`foreman-options-${issue.id}`, isLocalhost) + '<button class="prompt-copy">copy</button><button class="prompt-download" title="Download prompt as a .md file">download</button>' + foremanProxyToggle
        : '<button class="prompt-copy">copy</button><button class="prompt-download" title="Download prompt as a .md file">download</button>' + foremanProxyToggle
      const miniForemanActions = featureFlags.dispatch === true
        ? renderDispatchDisclosure(`mini-foreman-options-${issue.id}`, isLocalhost) + '<button class="prompt-copy">copy</button><button class="prompt-download" title="Download prompt as a .md file">download</button>' + foremanProxyToggle
        : '<button class="prompt-copy">copy</button><button class="prompt-download" title="Download prompt as a .md file">download</button>' + foremanProxyToggle
      const autopilotActions = featureFlags.dispatch === true
        ? renderDispatchDisclosure(`autopilot-options-${issue.id}`, isLocalhost) + '<button class="prompt-copy">copy</button><button class="prompt-download" title="Download prompt as a .md file">download</button>' + foremanProxyToggle
        : '<button class="prompt-copy">copy</button><button class="prompt-download" title="Download prompt as a .md file">download</button>' + foremanProxyToggle
