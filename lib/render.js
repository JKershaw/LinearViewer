...
export function renderPage(projectTrees, inProgressTrees = [], recentActivityTrees = [], organizationName = 'Projects', options = {}) {
  ...
  return renderPageShell({
    ...
    nav: navBarHtml,
    scripts: ['/common.js', '/purify.min.js', '/marked.min.js', '/app.js'],
...
function renderNode(node, parentId, options = {}) {
  ...
  // prompt/foreman/autopilot containers) is the dominant per-issue payload, so
 ...
 * comments shell, prompt/foreman/autopilot containers, View-in link) — without
