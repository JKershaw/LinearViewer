...
function renderPromptContainer({ name = '', content = '', issueId = '', urlKey = '', dispatchEnabled = false } = {}) {
  ...
  const actionButtons = dispatchEnabled
    ? '<span class="prompt-actions-label">Dispatch:</span><button class="prompt-dispatch dispatch-btn" data-target="cli">cli</button><button class="prompt-dispatch dispatch-btn" data-target="web">web</button><button class="prompt-dispatch dispatch-btn" data-target="dash">dash</button><button class="prompt-copy">copy</button>'
    : '<button class="prompt-copy">copy</button>'
