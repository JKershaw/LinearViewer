...
export function renderPage(projectTrees, inProgressTrees = [], recentActivityTrees = [], organizationName = 'Projects', options = {}) {
  const { isLanding = false, teams = [], selectedTeamId = null, workspaces = [], openRouterSource = null, urlKey = null, deployInfo = {}, featureFlags = {}, customPrompts = [], setupNotice = null, isLocalhost = false, showSource = false, heroHtml = null, truncated = false } = options
