...
export const QUEUE_CONFIG = [
  {
    ...
    excludeLabels: [],
    required: true,
    description: 'Tasks ready to be picked up (backlog or unstarted)'
  },
  {
    name: 'In-Progress',
  ...
  // Note: there is intentionally no Review queue. Most workspaces do not have a
  // dedicated `review` workflow state (LIN-357); the `review` action/prompt is a
  // universal option, not a state-based queue.
];
