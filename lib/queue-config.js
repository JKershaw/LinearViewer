 ...
 * Dynamically derived from prompt templates with category='pre-work'.
 * Used by implicit queues to exclude tasks that aren't ready.
 * @returns {string[]} Array of pre-work label names
 */
export function getPreWorkLabelsList() {
  return getPreWorkLabels();
}

// Legacy export for backwards compatibility
export const PRE_WORK_LABELS = getPreWorkLabels();
