...
export const QUEUE_CONFIG = [
  {
    ...
    labelPatterns: [PREPARING_LABEL],
    required: true,
    description: 'Tasks in pre-implementation work - research, breakdown, design, etc.'
  },
  {
    name: 'Ready',
    type: QUEUE_TYPES.IMPLICIT,
    stateTypes: ['backlog', 'unstarted'],
    excludeLabels: [PREPARING_LABEL],
    required: true,
    description: 'Tasks ready to be picked up (unstarted, no preparing label)'
  },
  {
    name: 'In-Progress',
