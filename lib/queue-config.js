...
import { getPreWorkLabels } from './prompt-templates.js';
import { PHASE_LABELS } from './workflow-config.js';
...
export const QUEUE_CONFIG = [
  {
    ...
    labelPatterns: [PHASE_LABELS.BREAKDOWN],
    required: true,
    description: 'Tasks in the breakdown phase - being split into smaller pieces'
  },
  {
    name: 'Research',
    type: QUEUE_TYPES.LABEL,
    labelPatterns: [PHASE_LABELS.RESEARCH],
    required: false,
    description: 'Tasks in the research phase - investigating unknowns'
  },
  {
    name: 'Ready',
    type: QUEUE_TYPES.IMPLICIT,
    stateTypes: ['backlog', 'unstarted'],
    excludeLabels: getPreWorkLabels(),
    required: true,
