...
function renderTerminalMarkedTaskCostCard(cost = {}, planFeeConfig = {}) {
  ...
  // the wire (issueCount, laneLandedCount) — no new field, mirroring the
  ...
  return renderCard({
    ...
    body: [
      ...
      '</span>',
      `<span class="kpi-cost-shares-ignorance-basis">of ${escapeHtml(formatNumber(lineageBearingCount))} with a lineage (${escapeHtml(formatNumber(laneLandedCount))} no-lineage excluded)</span>`,
