...
export const CHAT_TOOL_RESULT_BUDGETS = {
  ...
  //              ~250 of ids, stamps and flags) ~= 17k measured. LIN-2704
  //              projected two more id fields (`issueId`, `taskDecisionId`)
  //              onto every row, ~18.8k measured at 20 rows — re-measure
  //              rather than trust this comment if either field's cap moves.
