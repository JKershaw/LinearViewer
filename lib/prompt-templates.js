...
export const PROMPT_TEMPLATES = {
  ...
  'plan': {
    ...
    aiHint: {
      ...
      workflow: 'Set status to "In Progress" → Plan → Update description → Implement → Commit → Mark Done'
    },
    generate: (issue, context) => {
      const sections = [
...
3. **Update Linear**: Add findings as a comment on ${issue.identifier} via Linear MCP`,
        '',
        '## Context',
        '',
        formatSection('Project', formatProject(context.project)),
...
1. **Fetch details**: Use Linear MCP to get full issue details for ${issue.identifier}
2. **Analyze**: Complete the goal below
3. **Update Linear**: Add context summary as a comment on ${issue.identifier} via Linear MCP`,
        '',
        '## Context',
        '',
        formatSection('Project', formatProject(context.project)),
...
1. **Fetch details**: Use Linear MCP to get full issue details for ${issue.identifier}
2. **Review**: Complete the goal below
3. **Document**: Add review findings as a comment on ${issue.identifier} via Linear MCP`,
        '',
        '## Context',
        '',
