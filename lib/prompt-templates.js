...
export const PROMPT_TEMPLATES = {
  'needs-breakdown': {
    ...
    completionSignals: COMPLETION_SIGNALS['needs-breakdown'],
    aiHint: {
      situation: 'large, vague, or complex',
      goal: 'Break this task into smaller, actionable subtasks ordered by dependencies.',
      workflow: 'Fetch details → Analyze → Create subtasks → Add blocked-by relations → Add summary comment',
      readinessCheck: COMPLETION_SIGNALS['needs-breakdown']?.readinessCheck
    },
  ...
  'needs-research': {
    ...
    completionSignals: COMPLETION_SIGNALS['needs-research'],
    aiHint: {
      ...
      readinessCheck: COMPLETION_SIGNALS['needs-research']?.readinessCheck
    },
    generate: (issue, context) => {
      const sections = [
        ...
        '2. **Research**: Complete the goal below',
        `3. **Update Linear**:`,
  ...
  'needs-scoping': {
    ...
    completionSignals: COMPLETION_SIGNALS['needs-scoping'],
    aiHint: {
      ...
      readinessCheck: COMPLETION_SIGNALS['needs-scoping']?.readinessCheck
    },
    generate: (issue, context) => {
      const sections = [
        ...
        `1. **Fetch details**: Use Linear MCP to get full issue details for ${issue.identifier}`,
        '2. **Analyze**: Complete the goal below',
        `3. **Update Linear**: Update the issue description with the finalized scope via Linear MCP (preserves scope as canonical source of truth)`,
        '',
        '## Context',
        '',
        formatSection('Project', formatProject(context.project)),
  ...
  'needs-design': {
    ...
    completionSignals: COMPLETION_SIGNALS['needs-design'],
    aiHint: {
      ...
      readinessCheck: COMPLETION_SIGNALS['needs-design']?.readinessCheck
    },
    generate: (issue, context) => {
      const sections = [
  ...
  'needs-spike': {
    ...
    completionSignals: COMPLETION_SIGNALS['needs-spike'],
    aiHint: {
      ...
      readinessCheck: COMPLETION_SIGNALS['needs-spike']?.readinessCheck
    },
    generate: (issue, context) => {
      const sections = [
  ...
  'blocked': {
    ...
    aiHint: {
      ...
      readinessCheck: COMPLETION_SIGNALS['blocked']?.readinessCheck
    },
    generate: (issue, context) => {
      const sections = [
  ...
  'needs-context': {
    ...
    completionSignals: COMPLETION_SIGNALS['needs-context'],
    aiHint: {
      ...
      readinessCheck: COMPLETION_SIGNALS['needs-context']?.readinessCheck
    },
    generate: (issue, context) => {
      const sections = [
  ...
  'bug': {
    ...
    completionSignals: COMPLETION_SIGNALS['bug'],
    aiHint: {
      ...
      readinessCheck: COMPLETION_SIGNALS['bug']?.readinessCheck
    },
    generate: (issue, context) => {
      const sections = [
  ...
  'plan': {
    ...
    aiHint: {
      ...
      workflow: 'Set status to "In Progress" → Plan → Update description with plan → Implement → Update description with summary → Add "in-review" label'
    },
    generate: (issue, context) => {
      ...
      const sections = [
        ...
        `7. **Complete**: Update description with implementation summary, add "in-review" label to ${issue.identifier} to indicate ready for review`,
        '',
        '## Context',
        '',
        formatSection('Project', formatProject(context.project)),
