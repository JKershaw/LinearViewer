...
const DISPLAY_LABELS = {
  ...
  'passage-planner': 'passage planner',
  'ship-biscuit': "ship's biscuit",
  'live-console': 'live console',
  'ship-journey': 'ship journey'
};
...
export function renderViewNav({ urlKey = null, currentPage = '', featureFlags = {} } = {}) {
  ...
  if (overflow.length) {
    ...
    overflowMarkup = `
      <button type="button" class="nav-more-toggle" data-testid="nav-more-toggle" aria-expanded="false" aria-controls="nav-views-overflow">⋯ <span class="nav-more-label">more</span></button>
