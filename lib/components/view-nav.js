 ...
 *   - First-class (observation / swipe / swim / projects / settings): ALWAYS shown.
 ...
 * views (roadmap / dispatch / proxy) are the OVERFLOW group, collapsed behind a
 * `⋯ more` in-flow expander on narrow widths. Keyed on the bare view text so it
 * pairs with the key-equality active match and the single-source-of-truth list.
 */
 ...
 *
 * The first-class four are always primary; the flag-gated views are overflow.
 ...
 * (the design's active-hoist rule). It is appended after the first-class four
