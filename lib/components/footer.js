...
/**
 * All navigation links for the footer.
 * Current page will be shown in bold, others as links.
 */
const FOOTER_LINKS = [
...
export function renderPageFooter(options = {}) {
  const { deployInfo = {}, isLanding = false, showReset = false, currentPage = null } = options;
