...
export function renderPageFooter(options = {}) {
  ...
  const legalHtml = '<a href="/privacy" class="footer-legal">privacy</a> · <a href="/terms" class="footer-legal">terms</a>';
  const deployParts = [aiStatusHtml, deployHtml, legalHtml].filter(Boolean).join(' · ');
