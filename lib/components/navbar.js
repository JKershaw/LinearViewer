 ...
 * @property {'projects'|'settings'|'audit'|'prompts'|'dispatch'|'proxy'|'roadmap'} [currentPage] - Current page identifier
 ...
 * @param {Workspace[]} workspaces - Array of connected workspaces
 * @param {string|null} urlKey - Current workspace URL key from URL
 * @param {'projects'|'settings'|'audit'|'prompts'|'dispatch'|'proxy'|'roadmap'} currentPage - Current page to preserve on switch
