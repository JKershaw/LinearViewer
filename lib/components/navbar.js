 ...
 * @property {'projects'|'settings'|'audit'|'prompts'|'dispatch'|'pipeline'} [currentPage] - Current page identifier
...
function renderWorkspaceOptions(workspaces, urlKey, currentPage = 'projects') {
  ...
  const pageSuffix = (currentPage === 'projects' || currentPage === 'dispatch' || currentPage === 'proxy' || currentPage === 'roadmap' || currentPage === 'pipeline') ? '/' : `/${currentPage}`
