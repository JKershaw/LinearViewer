...
/**
 * Render the prompts page footer with deploy info and links
  ...
  return `
    <div class="prompt-card">
      <div class="prompt-header">
        ...
        <span class="prompt-chars">${template.charCount.toLocaleString()} chars</span>
      </div>
...
function renderTemplatesByCategory(templates) {
  ...
  const categoryOrder = ['Pre-Work', 'Work Issues', 'Ready', 'Universal'];
  const sections = [];
  ...
  <main>
    <section class="prompts-summary">
      <div class="summary-stats">
        ...
        <span class="stat"><strong>${promptsData.totalCharCount.toLocaleString()}</strong> total chars</span>
      </div>
    </section>
