 ...
 * BEFORE enqueueing, so a bad value never reaches the runner at all. The
 * runner's own reject (admission.js) remains the second line of defense.
 */
 ...
 * runner's own reject (admission.js) remains the fallback defense for
 * exactly this case. Only a provider that COULD answer and DID answer "no"
 * produces a refusal.
 *
 * @param {Object} params
