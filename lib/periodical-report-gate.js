 ...
 * is discovered by the executing agent at run time, per
 * docs/architecture/source-map.md). Without
  ...
  if (!hasReportEvidenceComment(comments)) {
    return {
      ...
      message:
        ...
        '(see docs/architecture/source-map.md\'s periodical report-location convention). Post the report, then a comment ' +
