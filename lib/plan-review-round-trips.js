...
function requireInstant(value, fnName, paramName) {
  if (typeof value !== 'string' || !Number.isFinite(toMs(value))) {
 ...
 *   Optional, but not unvalidated: when present it must parse, or this throws
 *   (LIN-2358). Absent (or any falsy value) simply omits `rulerContamination`
