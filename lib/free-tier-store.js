...
export class FreeTierStore {
  ...
  async canUse(urlKey) {
    ...
    try {
      ...
      return { allowed: true, remaining: this.dailyLimit, limit: this.dailyLimit, resetsAt: this._getResetsAt() };
    }
  }
  ...
  async recordUsage(urlKey) {
    ...
    try {
      ...
      if (existing) {
        ...
        // 7-day TTL for workspace records
      ...
      if (globalDoc) {
        ...
        // 24-hour TTL for global hourly records
