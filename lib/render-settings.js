 ...
 * free-text model input, and a free-text effort input (LIN-2616). Used for
 * both the workspace-wide default row and every per-prompt-type override row
 * (LIN-1095).
 *
 ...
 */
function renderDispatchDefaultRow({ label, namePrefix, testid, model = '', harness = '', effort = '', preselectDefault = false }) {
