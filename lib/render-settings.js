...
export function renderSettingsPage(workspaceName = 'Workspace', options = {}) {
  const { openRouterSource = null, deployInfo = {}, currentModel = '', availableModels = [], modelError = null, urlKey = null, workspaces = [], featureFlags = FEATURE_DEFAULTS, workspaceFeatures = WORKSPACE_FEATURE_DEFAULTS, llmStats = null, providerContextSummary = null, providerBindings = [], providerNotice = null, githubEnabled = true, jiraOAuthEnabled = true, dispatchDefaults = {}, dispatchDefaultsError = null, dispatchModelCatalog = [], aiModelOverrides = {}, aiOverridesError = null, dispatchPresets = [] } = options
