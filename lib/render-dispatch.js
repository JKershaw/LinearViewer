          ...
          <div class="children">${projectRepos.length > 0 ? `
            ...
            <div class="node">
              <div class="line dispatch-prompt-actions">
                ...
                <input type="text" class="dispatch-autopilot-goal" placeholder="goal (optional)" aria-label="Autopilot goal" maxlength="1000" />
                <button class="action-btn dispatch-load-autopilot" title="Load a general Autopilot kickoff — orient off the stack and run the loop until it needs you. Type a goal first to focus the run.">load Autopilot</button>` : ''}
