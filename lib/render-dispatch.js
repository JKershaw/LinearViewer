...
export function renderDispatchPage(workspaceName = 'Workspace', options = {}) {
  ...
  <main>
    ...
    ${renderSection({ boxed: true, className: 'dispatch-section', titleClass: 'section-header dispatch-section-header', title: 'Workspace Halt', body: `
      ...
      <p class="halt-disclaimer" data-testid="dispatch-halt-disclaimer">This page can load slowly when Linear or the database is degraded. If it hasn't loaded, use <code>POST /api/proxy/dispatch/halt</code> directly.</p>
