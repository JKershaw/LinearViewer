...
<body>
  ...
  <main>
          ...
          <div class="children">${projectRepos.length > 0 ? `
            ...
            <div class="node">
              <div class="line dispatch-prompt-actions">
                <span class="action-btns-label">Dispatch:</span>
                ...
                <button class="action-btn save dispatch-prompt-send" data-target="dash">dash</button>${featureFlags.proxy === true ? `
    ...
    <section class="dispatch-section">
      <h2 class="dispatch-section-header">Integration Guide</h2>
      <p class="guide-summary">Build a consumer that polls for and processes dispatched prompts.</p>
      <div class="tree">
        <div class="node">
    ...
    <section class="dispatch-section">
      <h2 class="dispatch-section-header">History <button class="action-btn history-refresh">refresh</button></h2>
