...
export const FEATURE_DESCRIPTIONS = {
  ...
  [FEATURES.FLIGHT_COMPANION]: 'Experimental: a live, in-page chat with a companion that watches work in flight and checks in with you on its own — approve or dismiss what it proposes. A copyable kickoff prompt for a full agent session is also on the page',
