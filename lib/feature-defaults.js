...
export const FEATURE_LABELS = {
  ...
  [FEATURES.DASHBOARD]: 'Dashboard (experimental)'
};
...
export const FEATURE_DESCRIPTIONS = {
  [FEATURES.LINEAR_MCP]: 'Agent prompts reference Linear by ID; the agent routes writes (comments, status, subtasks) through MCP instead of the proxy',
  ...
  [FEATURES.DASHBOARD]: 'Experimental: a realtime, mobile-first feed of autopilot runs across all your connected workspaces, with on-demand run summaries'
};
