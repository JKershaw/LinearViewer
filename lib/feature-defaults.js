...
export const FEATURE_DESCRIPTIONS = {
  ...
  [FEATURES.FLIGHT_COMPANION]: 'Experimental: a prototype for realtime chat with work in flight — surfaces a kickoff prompt you paste into a real Claude Code session so it acts as a friendly companion that monitors dispatches and proposes actions for your approval',
  ...
  [FEATURES.FEEDBACK_WIDGET]: 'Show a floating feedback button on every page; submit free-text feedback (with priority and an optional screenshot) as a fresh ticket. Also toggleable from the footer.',
