 ...
 *   answeredDecisionId: string|null, answeredDecisions: Array, telemetry: Object}}
 */
export function deriveLoopFacingFacts(feedback, isoDispatchedAt) {
  ...
  return { terminal, wake, decision, decisionEntryIndex, decisionCase, answeredDecisionId, answeredDecisions, telemetry };
}
