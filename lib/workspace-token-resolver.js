...
//
// Closed for SYMMETRY rather than on a demonstrated production path: the
// LIN-2278 review could find no concrete way to reach a workspace whose scalar
// `accessToken` mirror is empty while a GitHub binding still holds its
// `installationId`, and neither could this ticket. What WAS established is
// narrower and sufficient — the exemption on file covered one of two branches,
// and nothing pinned it either way. Option 2 (prove it unreachable) needs a
// proof nobody has produced; option 1 is the cheaper close, and after it no
// ranking site in this file compares raw expiry magnitudes with a sentinel in
// the running.
