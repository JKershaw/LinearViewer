 ...
 */
export function buildAutopilotKickoff({ baseUrl, issue = null, goal = '', originNote = '', mode = AUTOPILOT_MODE_DEFAULT, variant = AUTOPILOT_VARIANT_DEFAULT, standalone = false } = {}) {
...
- **A \`409 DUPLICATE_DISPATCH\` means someone else already started this exact step — it is not a
  ...
  aborts, a different kind on the same task, and a different workspace are never refused.
