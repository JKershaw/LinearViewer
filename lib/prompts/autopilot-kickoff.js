...
review point.`
    ...
    ? ` Separately, any ONE task in this run may take at most **${maxSessionsPerTask} worker ${sessionWord}**
— a per-task sibling bound (LIN-2934), also enforced server-side (\`409 BUDGET_EXHAUSTED\`,
