 ...
 */
export function buildAutopilotKickoff({ baseUrl, issue = null, goal = '', originNote = '', mode = AUTOPILOT_MODE_DEFAULT, variant = AUTOPILOT_VARIANT_DEFAULT, standalone = false, maxTasks = null } = {}) {
