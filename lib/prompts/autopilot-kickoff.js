 ...
 *   the resolved provider can't serve raw issue detail. Omitted/null ⇒ byte-identical
...
- The verbs you drive: orient/choose \`GET /stack?view=digest\` (compact one-line headlines, each
  ...
  list); verify ${issueDetailSupported ? '`GET /issues/{id}`' : 'via `GET /brief/{id}`'}, \`GET /search\`, plus the artifact URLs in \`[evidence]\`.
