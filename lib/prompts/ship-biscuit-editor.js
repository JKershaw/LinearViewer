...
{
  "frontPage": {
    "lede": string   // 1-3 short paragraphs synthesising the period for the front page. Warm, readable, honest. Ground it ONLY in the provided slices.
  },
  "index": [
    {
      "section":    string,      // one of: "The Wire" (recent/factual), "Deep Dive" (analysis), "The Column" (light/opinionated), "Weather" (by-the-numbers)
      "headline":   string,      // a standalone headline that reads on its own
      "dek":        string,      // a one-line teaser under the headline (a "dek")
