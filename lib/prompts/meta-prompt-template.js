...
- **Review prompts** must cross-reference the plan's cross-cutting concerns against the implementation steps to identify likely gaps — requirements that appear in the plan but not in any implementation step are the highest-priority review items.
