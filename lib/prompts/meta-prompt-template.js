...
\`close-out\` requires positive evidence that a review actually ran — a comment where a review recorded a verdict. A rich, detailed, or complete-looking description is not that evidence, and neither is the work merely looking done; if no such review comment is on the trail, the review has not happened — recommend \`review\`. When the evidence is ambiguous, default to \`review\`.
