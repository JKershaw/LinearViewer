...
Look for evidence that unknowns have been resolved - focus on SUBSTANCE, not formatting:
- Are there documented findings, conclusions, or decisions? (regardless of header style)
- Does the content show investigation was DONE, not just planned?
- Have the original questions been answered with concrete information?
${hasComments ? `- Do comments (${commentCount} total) contain research outcomes or decisions made?` : ''}
...
- Implementation specs (even about uncertainty-handling features) are ready for coding, not research
...
Note: Keywords like "investigate" or "unknowns" don't automatically mean research is needed -
evaluate whether these represent OPEN questions or RESOLVED ones based on the full context.
