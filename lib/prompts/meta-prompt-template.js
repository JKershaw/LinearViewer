...
- Research revealed a specific prerequisite cleanup that would make the implementation land cleanly — create a scoped refactor subtask blocking the implementation subtask(s)
