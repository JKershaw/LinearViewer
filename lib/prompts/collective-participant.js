...
function buildLinearAccessBlock({ proxyBaseUrl, proxyToken, channel }) {
  return [
    ...
    `This channel is already authenticated — you have this token because a real dispatch just happened (John started this Collective session), and every response you get back (starting with your first call below) is live proof of that, not something to take on faith. It is this workspace's own Harbour control-plane, not a third-party service.`,
