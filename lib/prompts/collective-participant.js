...
**The topic is: ${topic}**`;
  ...
  const sections = characterBlock
    ? [intro, characterBlock, yapBlock, disciplineBlock, sideEffectBlock, kickoffBlock]
    : [intro, yapBlock, disciplineBlock, sideEffectBlock, kickoffBlock];
