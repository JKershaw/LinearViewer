 ...
 * two-path rule (docs/architecture/prompt-system.md, "Prompt System (two
 * independent paths)") governs the registered template system, which a lane
 * dispatch never joins.
 *
