...
RULES:
- Cite specific data (milestone names, dates, velocity numbers) to support answers.
...
- Priorities: reference milestone ordering and status
...
- Progress: reference completion percentages
