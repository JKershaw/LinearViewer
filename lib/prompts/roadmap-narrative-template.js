...
- Tasks carry their Linear identifier (e.g. LIN-204) where one exists. Cite the identifier alongside the title at least on first mention of a task, so the reader can trace it back to the tracker.
