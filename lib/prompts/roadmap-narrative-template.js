...
- Use the original task and milestone names from the data. Do not rename them.
...
Current focus: What is in progress. Flag any stale tasks from SIGNALS with their age and what they block.

What is next: Upcoming work and milestone projections with confidence ranges. Incorporate estimation gap data if present.
