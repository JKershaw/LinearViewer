...
- Auth header on every call: \`Authorization: Bearer YOUR_TOKEN\` — a \`readWrite\` proxy token is
  supplied alongside this prompt (the +proxy block). Use that same token for every proxy call.
