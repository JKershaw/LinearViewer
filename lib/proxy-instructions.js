...
GET ${baseUrl}/api/proxy/rulings
  ...
  → { "count": 2, "rulings": [{ "decision": { "decision_id": "...", "question": "...",
        ...
        "effect": "resume|dispatch|record", "declaredEffect": "resume|dispatch|record" | null,
  ...
  → "effect" is a SEPARATE field from "disposition" — never merge the two
    ...
    read-only row is not guaranteed a null "effect"; only its
    "declaredEffect" is guaranteed null. "declaredEffect" is what the
