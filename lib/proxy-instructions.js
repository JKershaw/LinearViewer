...
POST ${baseUrl}/api/proxy/dispatch
  ...
  → { "id": "...", "status": "queued", "promptName": "...", "kind": "implementation", "issueIdentifier": "...", "target": "cli", "abort": false, "abortTo": null, "cascade": false, "sessionId": null, "dispatchedAt": "...", "consumerLastSeenAt": "..." } (a "cascade": true request instead returns { "success": true, "cascade": true, "closed": [...], "count": N })
...
GET ${baseUrl}/api/proxy/dispatch?issueIdentifier={LIN-42}&status={queued|taken|done|failed|blocked|aborted}&limit={n}
  ...
  → { "items": [{ "id": "...", "status": "queued|taken|done|failed|blocked|aborted", "kind": "implementation", "issueIdentifier": "...", "feedbackCount": 1, "consumerLastSeenAt": "...", "consumerPollWarning": null, ... }], "total": N }
...
GET ${baseUrl}/api/proxy/dispatch/{id}
  ...
  → { "id": "...", "status": "queued|taken|done|failed|blocked|aborted", "kind": "implementation", "consumerLastSeenAt": "...", "consumerPollWarning": null, "feedback": [{ "message": "...", "url": "...", "timestamp": "..." }], ... }
