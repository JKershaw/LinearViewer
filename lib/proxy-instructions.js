  ...
  → Query params (both additive; the default read with neither is
    ...
    non-root carrier's "anchor" now names the root instead of itself):
      ...
      "includeResolved=true" — also return decisions this endpoint would
        ...
        "resolution" field (see below). Covers LOOP rulings only: a
        task-bound row (anchor.taskDecisionId set) NEVER appears under
        this, answered or not — there is no answered-task-decision read on
        this endpoint today.
