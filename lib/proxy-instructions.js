...
POST ${baseUrl}/api/proxy/recommend-and-dispatch
  ...
  → REPO VALIDATION (LIN-2886) applies here too, same shape as POST /dispatch above, against whichever repo value this call resolves to after "repoInherited" precedence: { "error": "Unknown repo \"...\"", "code": "UNKNOWN_REPO", "knownRepos": [...] }.
