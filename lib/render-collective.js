...
export function renderCollectivePage(data, options = {}) {
  ...
  const transcriptBody = `<div class="collective-transcript-head">
      ...
      <ul class="collective-transcript chat-thread chat-thread--log" id="collective-transcript"></ul>
      ...
      <div class="collective-say chat-composer chat-composer--inline">
  ...
  return renderPage({
    ...
    stylesheets: ['/style.css', '/common-actions.css', '/chat.css', '/collective.css'],
    nav: navBarHtml,
    embeddedData: { globalVar: '__COLLECTIVE_DATA__', value: collectiveData },
    scripts: ['/common.js', '/chat.js', '/collective.js'],
