 ...
 * proxy-events.js / foreman-store.js.
 *
...
export class LlmCallLogStore {
   ...
   *
   * @param {string} urlKey - Workspace URL key
   * @returns {Promise<{totalCalls:number, totalCost:number, totalTokens:number, byFeature:Array<{feature:string, calls:number, cost:number}>, lastCallAt:string|null}>}
   */
