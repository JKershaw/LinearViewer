...
export function renderPrivacyPolicy({ deployInfo } = {}) {
  ...
  return renderPage({
    title: 'Privacy Policy - Linear Projects Viewer',
    stylesheets: ['/style.css'],
    bodyClass: 'is-landing',
    content: `${renderPageHeader({ title: 'Linear Projects Viewer', titleHref: '/' })}
...
export function renderTermsOfService({ deployInfo } = {}) {
  ...
  return renderPage({
    title: 'Terms of Service - Linear Projects Viewer',
    stylesheets: ['/style.css'],
    bodyClass: 'is-landing',
    content: `${renderPageHeader({ title: 'Linear Projects Viewer', titleHref: '/' })}
  <main class="legal-content">
    ...
    ${legalSection('Service Description', `<p>Linear Projects Viewer is a web application that provides a read-only view of your Linear projects and issues. It requires a valid Linear account to use.</p>`)}
