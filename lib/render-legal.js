...
<body>
  ...
  <main class="legal-content">
    ...
    <p>This application connects to the <a href="https://linear.app">Linear API</a> to fetch your projects and issues. If you enable AI features, requests are sent to <a href="https://openrouter.ai">OpenRouter</a> using either your connected account or a server-side API key.</p>
  ...
  <footer class="page-footer">
    <div class="footer-deploy"><a href="/privacy" class="footer-legal"><strong class="footer-current">privacy</strong></a> · <a href="/terms" class="footer-legal">terms</a></div>
  </footer>
</body>
</html>`;
}
...
<body>
  ...
  <footer class="page-footer">
    <div class="footer-deploy"><a href="/privacy" class="footer-legal">privacy</a> · <a href="/terms" class="footer-legal"><strong class="footer-current">terms</strong></a></div>
  </footer>
</body>
</html>`;
}
