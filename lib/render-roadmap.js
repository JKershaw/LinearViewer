...
export function renderRoadmapPage(data, options = {}) {
  ...
  const layerSection = (layerId, heading, modifier = '') => `
        <div class="roadmap-layer${modifier ? ' ' + modifier : ''}" data-layer="${layerId}" data-state="idle">
  ...
  const pipelineSkeleton = `
      ...
      ${layerSection('digest', 'At a glance', 'roadmap-layer--digest')}
