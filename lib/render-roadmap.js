...
export function renderRoadmapPage(data, options = {}) {
  ...
  // Narrative + chat placeholders (populated client-side when AI is connected)
  const narrativeClass = hasAI ? 'roadmap-section roadmap-narrative' : 'roadmap-section roadmap-narrative hidden';
...
<body>
  ...
  <main class="roadmap-page" data-url-key="${encodedUrlKey}">
    ...
    ${shipLogHtml}
    ${projectsSectionHtml}
    <section class="${narrativeClass}" id="roadmap-narrative">
