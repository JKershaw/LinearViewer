...
8. **File follow-ups**: Create any remaining follow-up tickets the review named, routed to the right project and linked to the source task.`,
        '',
        '## Context',
        '',
        formatSection('Project', formatProject(context.project)),
        ...
        '5. File any remaining review or task follow-ups as separate tickets, routed to the right project and linked to the source.',
        '',
