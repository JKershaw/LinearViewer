  ...
  'plan': {
    ...
    generate: (issue, context, featureFlags = {}) => {
      const sections = [
        ...
        '',
        '**History signal:** Run `git log --oneline -10 -- <files in your plan>`. If recent commits touch the same code paths, review them carefully: what was the issue, and could your changes affect or depend on that? Document any identified constraints explicitly in the plan.',
        '',
