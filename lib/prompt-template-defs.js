...
8. **File follow-ups**: Create any remaining outside-scope follow-up tickets the review named, routed to the right project and linked to the source task, each carrying a priority and a type label (see Follow-up Triage below).`,
        '',
        '## Context',
        '',
        formatSection('Project', formatProject(context.project)),
