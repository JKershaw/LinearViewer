...
9. **Update Linear**: Add a summary comment in Linear with the PR link`,
  ...
  'close-out': {
    name: 'close-out',
    category: PROMPT_CATEGORIES.UNIVERSAL,
    description: 'Final close-out after an approved review: discharge the Not-Proven-by-CI ledger, then merge, set Done, post the summary, archive & prune, and file remaining follow-ups. Use when review has Approved and the PR is green.',
