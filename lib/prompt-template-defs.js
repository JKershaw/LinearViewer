...
import { linearPriorityToCanonical } from './providers/models.js';
 ...
 * native `priority` int with no `priorityLabel` (LIN-2316).
 * @param {Object} issue
 * @returns {string}
 */
function formatTriagePriority(issue) {
  ...
  return `${label}priorityLevel ${level} (ascending, 4 = highest)`
}
