  ...
  'review': {
    ...
    generate: (issue, context, featureFlags = {}) => {
      const sections = [
        ...
        '### Manual Testing',
        '',
        'Flag if any changes would benefit from manual verification — for example:',
        '- Visual or layout changes that automated tests can\'t fully validate',
        '- User-facing flows where the experience matters beyond functional correctness',
        '- Environment-specific behavior (auth, external services, browser quirks)',
        '',
        'If manual testing is warranted, describe what to test and what to look for.',
        '',
        '### Completion',
        '',
        'When review passes:',
