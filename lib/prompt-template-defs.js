...
6. **Update Linear**: Add summary comment in Linear`,
        ...
        '',
        'Start by reading the plan in the description. Confirm the files it names still exist, the surfaces still map to current code, and the session-fit answer still looks right given the codebase now. If something has drifted, stop and recommend re-planning before implementing.',
        '',
