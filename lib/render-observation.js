...
export function renderObservationPage(data, options = {}) {
  ...
  // wiring) is dropped. (The obs-appbar's sticky/translucent feel now lives on
  // the shared `.nav-bar`, restored globally in LIN-984 with the click-intercept
  // fix — see the note on `.nav-bar` in style.css.)
