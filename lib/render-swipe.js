 ...
 * then by state, then by priority. (LIN-1253: backlog / low-priority bugs are no
 * longer boosted — see isBoostableBug.)
 *
...
export function renderSwipePage(data, options = {}) {
  ...
  return renderPage({
    ...
    scripts: ['/common.js', '/purify.min.js', '/marked.min.js', '/recap.js', '/brief.js', '/context.js', '/prompt-section.js', '/sessions.js', '/swipe.js'],
