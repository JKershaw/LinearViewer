 ...
 * @returns {string}
 */
export function formatNextRunContext(model, organizationName = '', roadmapNarrative = null) {
 ...
 */
export async function generateGoalSuggestions({ projects = [], issues = [], organizationName = '', roadmapReport = null } = {}, options = {}) {
  ...
  const context = formatNextRunContext(roadmapModel, organizationName, roadmapNarrative);
