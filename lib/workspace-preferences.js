...
export function resolveRoutingFromConfig(config, kind, options = {}) {
  ...
  // the check, so a standalone call stays byte-identical to pre-LIN-1694 behavior — and when this
  // config IS the harness source, null is exactly right: the row then answers both fields and is
