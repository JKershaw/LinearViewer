...
| [capability-ledger](harbour/capability-ledger.md) | What has each model been seen to do on Harbour's tasks? | Edition 1. Opus 5 does every step and is the judge; Sonnet 5 implements and plans to the gate's standard; GLM-5.3, DeepSeek V4.1 Flash and V4 Flash implement grounded small tickets to Opus approval within one round and have been tried on nothing else; gpt-oss-120b and Llama 8B produced no work. |
