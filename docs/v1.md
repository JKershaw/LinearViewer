...
**In:** the eight steps; the prompt under Go; the run experience as designed work; a ring-fenced free tier; the hardening gate before anyone outside the operator is invited.
...
2. The run experience, the PR with its evidence, the merge click, the share link.
...
7. The invited period: specific people, watched. Billing, then the paper on what they did.
