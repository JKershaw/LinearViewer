...
- **Regex-derived function sizes.** This run caught two artifacts before printing them: `simple-dispatcher/terminal-driver.js:352 appendLaunchMetric` (scan: 445 lines; actual: **8**) and `lib/dispatch-store.js:116` (scan: 2,063 lines; actually a class body). **Every size figure in this report was eyeballed at source.**
